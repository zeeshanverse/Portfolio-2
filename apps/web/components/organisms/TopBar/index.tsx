...
const sectionIds = ['top', 'projects', 'stack', 'about', 'contact']
...
const navItems = [
  ...
  { id: 'about-page', href: '/about', label: 'more about' },
...
const TopBar = () => {
  ...
  const isActive = (id: string) => {
    ...
    if (id === 'about-page') return onAbout
    if (id === 'about') return !onSubpage && sectionActive === id
